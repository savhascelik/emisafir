                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                <tr v-for="room in rooms" :key="room.id">
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        ...
                                        <button @click="deleteRoom(room.id)" class="ml-1 bg-transparent hover:bg-red-500 text-blue-700 font-semibold hover:text-white py-1 px-1 border border-blue-500 hover:border-transparent rounded">
                                        Sil
                                        </button>
            ...
            return (using/capacity)*100;
                ...
                if(this.$store.state.loginState)
                    ...
                    const config = {
                        ...
                        axios.post(this.$store.state.apiUrl+this.$store.state.deleteRoom,{
                            id:room_id
                        }, config)
                        .then((response)=> {
