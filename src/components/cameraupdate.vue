...
const props=defineProps({
  photopath: {String, default:false},
})
...
<div class="flex items-center">
    <img :src="props.photopath" v-if="!isCameraOpen" v-show="!isLoading" @click="toggleCamera"  />


<div class=" justify-center w-full " v-if="!isCameraOpen & !props.photopath" v-show="!props.photopath & !isLoading"  @click="toggleCamera">
...
import cameralogo_url from '@/assets/img/camera--v2.png'
